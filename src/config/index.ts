...
import audioConfig, { UploadAudioHooksType } from './audio'
// 字典类型
export type DicType = {
    [key: string]: string
}
...
export type ConfigType = {
    ...
    onlineAudioCheck: Function
    onlineAudioCallback: Function
    ...
    uploadAudioParams: DicType
    uploadAudioParamsWithUrl: boolean
    uploadAudioHeaders: DicType
    uploadAudioHooks: UploadAudioHooksType
    uploadAudioTimeout: number
    withAudioCredentials: boolean
    customUploadAudio: Function | null
    customInsertAudio: Function | null
}
